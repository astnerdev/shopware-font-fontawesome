...
composer dependencies with development packages, and executes the Shopware unit
and storefront test suites via `vendor/bin/phpunit`. Locally you can reproduce
